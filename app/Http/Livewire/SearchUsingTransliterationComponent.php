...
class SearchUsingTransliterationComponent extends Component
{
    ...
    {
        $search_using_translitaration = AyatWord::where('transliteration_word', 'like', '%'.$this->searchUsingTransliterationOne.'%')->paginate($this->sortingValue);
        ...
        return view('livewire.search-using-transliteration-component', ['search_using_translitaration'=>$search_using_translitaration])
        ->layout('layouts.base');
    }
}

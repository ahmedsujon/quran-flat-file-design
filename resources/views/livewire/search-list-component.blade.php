<div>
    <div class="px-4 py-5 my-5 text-center">
        ...
        <div style="padding-bottom: 40px;" class="col-lg-6 mx-auto">
            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                <a style="padding: 20px; width: 300px;" href="{{ route('display.complete.quran-by.word') }}" class="btn btn-primary btn-lg px-4 gap-3">Display
                ...
                <a style="padding: 20px; width: 300px;" href="{{ route('display.complete.quran.by.category') }}" class="btn btn-primary btn-lg px-4 gap-3">Display
                    ...
                    <a style="padding: 20px; width: 300px;" href="{{ route('search.dropdown') }}" class="btn btn-primary btn-lg px-4 gap-3">Select One From Flowing Searches</a>
            </div>
        </div>

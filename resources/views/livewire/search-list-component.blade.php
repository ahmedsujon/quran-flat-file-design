<div>
    <div class="px-4 py-5 my-5 text-center">
        ...
        <div style="padding-bottom: 40px;" class="col-lg-6 mx-auto">
            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                <a style="padding: 20px; width: 300px;" href="" class="btn btn-primary btn-lg px-4 gap-3">Display
                    Complete Quran Sorted By English Word/Subject</a>
                <a style="padding: 20px; width: 300px;" href="" class="btn btn-primary btn-lg px-4 gap-3">Display
                    Complete Quran Sorted By English Sub-Category</a>
                <a style="padding: 20px; width: 300px;" href="" class="btn btn-primary btn-lg px-4 gap-3">Arabic
                    Search</a>
            </div>
        </div>
    </div>

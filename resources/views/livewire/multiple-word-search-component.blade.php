      ...
      <div class="card-body">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <button wire:click.prevent="tabchnage('tabOne')" class="nav-link @if($tabStatus == 'tabOne') active @endif" id="pills-home-tab" type="button" >Search by Arabic Root
              word</button>
          </li>
          <li class="nav-item" role="presentation">
            <button wire:click.prevent="tabchnage('tabTwo')" class="nav-link @if($tabStatus == 'tabTwo') active @endif" id="pills-profile-tab"type="button">Search by Normalize Arabic
              Word</button>
          </li>
          <li class="nav-item" role="presentation">
            <button wire:click.prevent="tabchnage('tabThree')" class="nav-link @if($tabStatus == 'tabThree') active @endif" id="pills-contact-tab"  type="button">Search by Actual Arabic Words
              in Quran</button>
          </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
          ...
          <div class="tab-pane fade @if($tabStatus == 'tabTwo') show active @endif">
            ...
            <div style="overflow-x:auto;">
              <table id="myTable">
                ...
                @php
                $sl = ($multiple_words_search_tab_two->perPage() * $multiple_words_search_tab_two->currentPage())-($multiple_words_search_tab_two->perPage() - 1)
                @endphp
          ...
          <div class="tab-pane fade @if($tabStatus == 'tabThree') show active @endif">
            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
              <input dir="rtl" wire:model="multipleWordSearchTabThree" type="text" id="myInput" onkeyup="myFunction()"
            ...
            <div style="overflow-x:auto;">
              <table id="myTable">
                ...
                @php
                $sl = ($multiple_words_search_tab_three->perPage() * $multiple_words_search_tab_three->currentPage())-($multiple_words_search_tab_three->perPage() - 1)
                @endphp
